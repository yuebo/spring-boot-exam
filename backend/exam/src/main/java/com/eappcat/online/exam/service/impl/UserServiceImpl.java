...
import com.eappcat.online.exam.entity.Action;
import com.eappcat.online.exam.entity.Page;
import com.eappcat.online.exam.entity.Role;
import com.eappcat.online.exam.entity.User;
import com.eappcat.online.exam.enums.RoleEnum;
import com.eappcat.online.exam.qo.LoginQo;
import com.eappcat.online.exam.utils.JwtUtils;
...
public class UserServiceImpl implements UserService {
    ...
    public User register(RegisterDTO registerDTO) {
        User dbUser=userRepository.findByUserUsername(registerDTO.getUsername());
        if (dbUser==null){
            User user = new User();
    ...
    public String login(LoginQo loginQo) {
        User user=userRepository.findByUserUsername(loginQo.getUserInfo());
        if (user != null) {
