...
export function getLastExamRecord (examId) {
  return axios({
    url: api.LastExamRecord + examId,
    method: 'get',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
    }
...
export function saveExamRecord (examRecordId, answersMap) {
  return axios({
    url: api.SaveExamRecord + examRecordId,
    method: 'post',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
    },
