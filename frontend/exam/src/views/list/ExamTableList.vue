        ...
        <a-row :gutter="48">
          ...
          <a-col :md="!advanced && 8 || 24" :sm="24">
            <span
              ...
              <a-button style="margin-left: 8px" @click="showModal">上传</a-button>
              <a-button style="margin-left: 8px" @click="systemReset">系统重置</a-button>
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <p class="ant-upload-hint">支持拖动或者点击
          </p>
        </a-upload-dragger>
      </a-modal>
    </div>
...
import { systemReset } from '../../api/user'
...
export default {
  ...
  methods: {
    ...
    handleEdit (record) {
      ...
      console.log(record)
      this.$refs.createExamModal.edit(record)
    },
    handleSub (record) {
      // 查看题目，不在模态框里查啦，太麻烦
      // console.log(record)
